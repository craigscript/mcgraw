									...
									<div class="panel panel-default box box-success">
											...
											<div class="panel-body text-center">
												<form class="form-inline form-group" role="form" id="quickForm" action="" method="post" enctype="multipart/form-data">
													...
													<div class="form-group m-l-10">
														<button type="submit" class="btn btn-primary btn-lg waves-effect waves-light m-l-10" value="submit" name="submit">Add Tenant</button>
													</div> 
												</form>
											</div>
										</div>
									...
									<div class="panel panel-default box box-success">
										...
										<div class="panel-body text-center">
											<form class="form-inline form-group">
												<div class="form-group m-l-10">
												<a href="#modal1" class="btn btn-primary btn-lg waves-effect waves-light m-l-10">Create Tenant</a>
												</div>
											</form>
										</div>
									</div>	
