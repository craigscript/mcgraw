                        ...
                        <div class="container">
                            <div class="row">
									...
									<div class="panel panel-default">
											...
											<div class="panel-body text-center">
												<form class="form-inline form-group" role="form" id="quickForm" action="" method="post" enctype="multipart/form-data">
													...
													<div class="form-group m-l-10">
														<button type="submit" class="btn btn-primary btn-lg waves-effect waves-light m-l-10" value="submit" name="submit">Add Vendor</button>
													</div> 
												</form>
											</div>
										</div>
								...
								<div class="col-sm-6">
									<div class="panel panel-default">
										<div class="panel-heading">
											<h4 class="panel-title">Add New Vendor</h4>
										</div>
										<div class="panel-body text-center">
											<form class="form-inline form-group">
												<div class="form-group m-l-10">
												<a href="#modal1" class="btn btn-primary btn-lg waves-effect waves-light m-l-10">Create Vendor</a>
												</div>
											</form>
										</div>
									</div>	
                        		...
                        		<div class="list-group text-center">
                        			<?php foreach ($dbItems as $dbItem) { ?>
                        				<a href="#modal1" id="btn-default-<?php echo $dbItem['id']; ?>" class="list-group-item" onclick="getDBItem(<?php echo $dbItem['id'] . ",'" . $page . "'"; ?>)">
                        					<h5 class="left asset-label valign"> <?php echo $dbItem["Customer Name"]; ?></h5>
                        				</a>
					      				...
					      				<?php foreach ($fields[$tab] as $field){ 
			      							...
			      							<?php
						      						...
						      						<div class=" form-group col-<?php  
							      						...
							      						<a class="btn btn-primary" id="<?php echo friendly($field->name) . "_go"; ?>" href="<?php if($field->related = "Vendor"){echo "vendor.php#item-[id]";}; ?>" >search</a>
...
<!--
						      							<a class="btn btn-primary" id="<?php echo friendly($field->name) . "_go"; ?>" href="<?php if($field->related = "Vendor"){echo "vendor.php#item-[id]";}; ?>" ><i class="material-icons">search</i></a>
-->						      						
