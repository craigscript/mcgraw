					    		...
					    		<div class="col-xs-12">
					      			<div class="row">
					      				...
					      				<!--				<div class="form-group col-md-8 col-md-offset-2">
													    	<a class="btn btn-primary" id="<?php echo friendly($field->name) . "_get"; ?>" href="" ><i class="material-icons">file_download</i></a>
					      									<div class="input-file mcfile">
													      		<div class="btn">
													        		<span>File</span>
													        		<input name="<?php echo friendly($field->name) . "_file"; ?>" id="<?php echo friendly($field->name) . "_file"; ?>" type="file">
													      		</div>
										...
										-->
					      						...
					      						<div class="form-group input-group col-<?php  
						      						if($field->width === "Full"){
						      							echo "sm-12";
						      						}elseif($field->width === "Half"){
						      							echo "md-6 col-xs-12";
						      						...
						      						<div class="row container">
						          						<select name="<?php echo friendly($field->name); ?>" id="<?php echo friendly($field->name); ?>" class="form-control col-xs-12 col-md-12 col-lg-12">
					      				...
					      				<?php 
					      					...
					      					?>
					      						...
					      						<div class="form-group input-field col-<?php  if($field->width === "Full"){
					      							echo "sm-12";
					      						}elseif($field->width === "Half"){
					      							echo "md-6 col-xs-12";
					      						}else{
